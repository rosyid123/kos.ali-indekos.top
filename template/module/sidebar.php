        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-key"></i>
                <span>Kosong / Penuh</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="?module=transaksi/Kosong"><i class="fa fa-circle-o"></i> Kosong</a></li>
                <li><a href="?module=transaksi/Penuh"><i class="fa fa-circle-o"></i> Penuh</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li class="header">ADMINISTRASI KOS-KOSAN</li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-bed"></i>
                <span>Kamar</span>
